...
A curated list of awesome streamlit resources. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 321,960 | 🐛 19 | 🌐 Python | 📅 2026-09-20 and [awesome-pandas](https://github.com/tommyod/awesome-pandas) ⭐ 574 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-06-04.
...
Please contribute to improving the Streamlit package at [GitHub/streamlit/streamlit](https://github.com/streamlit/streamlit) ⭐ 45,803 | 🐛 1,167 | 🌐 Python | 📅 2026-09-20
...
* [mypy](https://github.com/python/mypy) ⭐ 20,645 | 🐛 3,232 | 🌐 Python | 📅 2026-09-20 for static type checking
* [pytest](https://github.com/pytest-dev/pytest) ⭐ 14,519 | 🐛 826 | 🌐 Python | 📅 2026-09-20 for unit to functional tests
* [autoflake](https://github.com/myint/autoflake) ⭐ 953 | 🐛 44 | 🌐 Python | 📅 2026-08-23 to remove unused imports and unused variables
