...
A curated list of awesome streamlit resources. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 321,568 | 🐛 25 | 🌐 Python | 📅 2026-09-18 and [awesome-pandas](https://github.com/tommyod/awesome-pandas) ⭐ 574 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-06-04.
...
Please contribute to improving the Streamlit package at [GitHub/streamlit/streamlit](https://github.com/streamlit/streamlit) ⭐ 45,782 | 🐛 1,164 | 🌐 Python | 📅 2026-09-19
...
* [mypy](https://github.com/python/mypy) ⭐ 20,644 | 🐛 3,235 | 🌐 Python | 📅 2026-09-18 for static type checking
* [pytest](https://github.com/pytest-dev/pytest) ⭐ 14,517 | 🐛 821 | 🌐 Python | 📅 2026-09-18 for unit to functional tests
* [autoflake](https://github.com/myint/autoflake) ⭐ 953 | 🐛 43 | 🌐 Python | 📅 2026-08-23 to remove unused imports and unused variables
